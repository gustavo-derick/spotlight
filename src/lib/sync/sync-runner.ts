...
type SupabaseClient = any // Usando any para facilitar a tipagem cruzada entre server e admin clients
...
export async function runSync(supabase: SupabaseClient): Promise<{
  processed: number
  skipped: number
  errors: number
}> {
